...
def get_radar_chart(input_data):
	...
	fig.add_trace(go.Scatterpolar(
			r=[
			0, 0, 0,
			0,input_data['concavity_mean'], input_data['concave points_mean'], 0
			],
			theta=categories,
			fill='toself',
			name='Mean Value'
	...
	fig.add_trace(go.Scatterpolar(
			r=[
			input_data['radius_se'],0, input_data['perimeter_se'], input_data['area_se'], 0,0,0
			],
			theta=categories,
			fill='toself',
			name='Standard Error'
	...
	fig.add_trace(go.Scatterpolar(
			...
			input_data['area_worst'], input_data['concavity_worst'], input_data['concave points_worst'], 
