...
with st.sidebar:
    ...
    selected = option_menu("Menu", ['Information', 'Exploratory Analysis', 'Machine Learning', 'Ask the AI', 'Sources'])
    selected

cd_2018 = pd.read_csv('data/cd_2018.csv')
df = pd.read_csv('data/dataset_factorised.csv')
...
if 'AI' in selected:
    ...
    st.write('Here you can ask the AI any question you want about the data\n')
    ask_pandas()
